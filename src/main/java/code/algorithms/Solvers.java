...
public class Solvers {
    ...
    /**
     * @param position1D   takes in the individual vector component of position
     * @param planetObject takes in the current planet for which the acceleration is being calculated for
     * @param otherObject  takes in the planet to which the current planet is being compared to
     * @param i
     * @return
     */
    ...
    public static void midPoint(PlanetObject planetObject, PlanetObject otherObject, double h) {
        ...
        /*for (int i = 0; i < 3; i++){
            positionalVector[i] += h * accelerationForSolvers(positionalVector[i]+(1/2)*h*accelerationForSolvers(positionalVector[i], planetObject, otherObject, i), planetObject, otherObject, i);
            velocityVector[i] += h * accelerationForSolvers(velocityVector[i]+(1/2)*h*accelerationForSolvers(velocityVector[i], planetObject, otherObject, i), planetObject, otherObject, i);
        }*/
}
